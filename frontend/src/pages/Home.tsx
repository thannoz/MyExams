    ...
    <div className="bg-gray-300 h-screen">
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-300 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                ...
                <img className="h-14 w-auto" src="./img/LogoReal.png" alt="" />
              </a>
              <button
                type="button"
                ...
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <Link
                      key={item.name}
                      to={item.href}
                      className="font-lato -mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-200"
                    >
                      {item.name}
                    </Link>
                  ))}
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div
          ...
          aria-hidden="true"
        >
          {/* Farbenverlauf von oben-links nach unten-rechts  */}
          <div
        ...
        <div
          className="bg-gray-200 absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]"
          aria-hidden="true"
        >
          {/* Farbenverlauf von unten-rechts nach oben-links */}
          <div
